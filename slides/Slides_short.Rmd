...
author: "Rodolfo L. Chavez Dominguez"
...
<img src="./Images/RNA_isolation.jpeg" width="500px" class="center">
</img>
...
Crear un objeto `DESeq` (*SummarizedExperiment*) a partir del objeto `gse`
```{r, echo = T, eval = T}
...
Visualizar el grupo de referencia o **control** de la variable seleccionada
```{r, echo = T, eval = T}
##El  primer nivel o elemento es el grupo control  ("CT")
levels(dds$Treatment)
```

Dependiendo de la pregunta a responder, recodifica el  grupo de referencia:
```{r, echo = T, eval = T}
...
Selecciona aquellos genes que muestran mayor abundancia usando un punto de corte
```{r, echo = T, eval = T}
...
.content-box-red[
<strong>NUNCA</strong> realices la prueba de expresión diferencial con un valor de corte X (log2FoldChange) y posteriormente filtres los genes diferencialmente expresados empleando otro valor de log2FoldChange.
]
